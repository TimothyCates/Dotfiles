...
local awesomebuttons = require("widgets.awesomeButtons.awesome-buttons")


local HOME_DIR = os.getenv("HOME")
local WIDGET_DIR = HOME_DIR .. '/.config/awesome/widgets/turtleWidgets/logout'
...
local function launch(args)
    ...
    local onlock = args.onlock or function() awful.spawn.with_shell([[betterlockscreen --lock && betterlockscreen -u "]] .. beautiful.lockscreenImages .. [[" --fx]]) end
